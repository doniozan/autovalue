    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentusedcar" role="tab" data-toggle="tab">List Car Used</a></li>
        </ul>
      </div>
      <!-- Recently Listed New Cars -->
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="resentusedcar">
        	@php
            	$number = 0
          	@endphp
        	...
        	<div class="col-list-3">
            	<div class="recent-car-list">
              		<div class="car-info-box"> <a href="#"><img src="/../images/600x380.jpg" class="img-responsive" alt="image"></a>
                		<div class="compare_item">
                  			<div class="checkbox">
                    			<input type="checkbox" id="compare{{ $number++ }}">
                		...
                		<ul>
							...
							<li><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $data->pelanggan->alamat }}</li>
                		</ul>
              		</div>
              		<div class="car-title-m">
                		<h6><a href="#">{{ $data->type->type_mobil }}</a></h6>
    ...
    <div class="row">
      <div class="col-list-3">
        <div class="featured-car-list">
          <div class="featured-car-img"> <a href=""><img src="/../images/600x380.jpg" class="img-responsive" alt="Image"></a>
      ...
      <div class="col-lg-12">
        <div id="trending_slider">
          <div class="trending-car-m">
            <div class="trending-car-img"> <img src="/../images/600x380.jpg" alt="Image" class="img-responsive" /> </div>
            <div class="trending-hover">
              <h4><a href="#">Car Name</a></h4>
            </div>
          </div>
          <div class="trending-car-m">
            <div class="trending-car-img"> <img src="/../images/600x380_2.jpg" alt="Image" class="img-responsive" /> </div>
            <div class="trending-hover">
              <h4><a href="#">Car Name</a></h4>
            </div>
          </div>
    ...
    <div class="row">
      <div id="testimonial-slider">
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="/../images/300x300.jpg" alt="images" /> </div>
      ...
      <div class="col-md-4 col-sm-4">
        <article class="blog-list">
          <div class="blog-info-box"> 
            ...
            <a href="#"><img src="/../images/600x380.jpg" class="img-responsive" alt="image"></a>
            <ul>
